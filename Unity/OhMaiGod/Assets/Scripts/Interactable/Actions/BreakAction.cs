...
[CreateAssetMenu(fileName = "BreakAction", menuName = "Game/Interaction Actions/Break")]
public class BreakAction : InteractionAction
{
    // 프롬프트에 전달할 액션 이름
    [SerializeField] private string _actionName = "Break";
